...
urlpatterns = [
    ...
    path("<int:pk>/spvsrs/connecting/cancel/", views.TeamSpvsrsConnectingCancelByOneself.as_view()),
    path("<int:pk>/spvsrs/connecting/cancel/byfounder/", views.TeamSpvsrsConnectingCancelByFounder.as_view()),
    path("<int:pk>/spvsrs/connect/", views.TeamSpvsrsConnect.as_view()),
    path("<int:pk>/spvsrs/connect/cancel/", views.TeamSpvsrsConnectCancelByOneself.as_view()),
    path("<int:pk>/spvsrs/connect/cancel/byfounder/", views.TeamSpvsrsConnectCancelByFounder.as_view()),
